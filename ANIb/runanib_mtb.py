...
input_dir = "/home/amathew6/ANIProject/ANIb/mtb_3genomes" #where my genomes.fna files live
output_dir = "/home/amathew6/ANIProject/ANIb/mtb_ANIb_results" #where all the files that I am generating get output
...
print("Starting ANIb run...") #i added print statements becauscd e when I first ran this the first few times it didn't work and I wanted to see where my code was failing
...
subprocess.run([
    ...
    "-m", "ANIb",  #shows what kind of ANIb I want to run 
...
df = pd.read_csv("/home/amathew6/ANIProject/ANIb/mtb_ANIb_results/ANIb_percentage_identity.tab", sep="\t", index_col=0) #creates an easy readable table to interpret ANIb results 
