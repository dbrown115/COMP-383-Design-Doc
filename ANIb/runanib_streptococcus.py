#before running script, one needs to open up the pyANI environment on their terminal 
# run conda activate pyani_env in your terminal 
#you should see (pyani_env) instead of base and that's how you know you're in the pyANI environment 
import subprocess #used to run pyANI
import os
import pandas as pd #used it to visualize my data in a "table" format


input_dir = "/home/amathew6/ANIProject/ANIb/streptococcus_3genomes" #where my genomes.fna files live
output_dir = "/home/amathew6/ANIProject/ANIb/streptococcus_ANIb_results" #where all the files that I am generating get output
