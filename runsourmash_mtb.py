#first activate pyani_env 
#steps to activate pyani_env can be found on the GitHub
...
input_dir = "/home/amathew6/ANIProject/SourMASH/mtb_3genomes" #where the genomes live
output_dir = "/home/amathew6/ANIProject/SourMASH/mtb_SourMASH_results" #where I want my results stored
...
print("Exporting CSV...") #outputs answer as a csv file
