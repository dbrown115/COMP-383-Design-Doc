...
input_dir = "/home/amathew6/ANIProject/ANIm/mtb_3genomes" #where my genomes.fna files live
output_dir = "/home/amathew6/ANIProject/ANIm/mtb_ANIm_results" #where all the files that I am generating get output
...
subprocess.run([
    ...
    "-f" "-f" #when running this script many time -f is used to force a manual overwrite 
], check=True)
