...
input_dir = "/home/amathew6/ANIProject/ANIb/streptomyces_3genomes" #where my genomes.fna files live
output_dir = "/home/amathew6/ANIProject/ANIb/streptomyces_ANIb_results" #where all the files that I am generating get output
...
df = pd.read_csv("streptomyces_3genomes_ani/ANIb_percentage_identity.tab", sep="\t", index_col=0) #creates an easy readable table to interpret ANIb results 
